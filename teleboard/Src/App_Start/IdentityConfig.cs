...
namespace Teleboard
{
    public class EmailService : IIdentityMessageService
    {
        ...
        {
            new MailService().Send(message.Destination, "", "", message.Subject, message.Body, "");
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        //{
        //    var code = await this.GeneratePasswordResetTokenAsync(userId);
    ...
    public class ApplicationRoleManager : RoleManager<ApplicationRole>
    {
        ...
        {
            var store = new RoleStore<ApplicationRole>(context.Get<ApplicationDbContext>());
